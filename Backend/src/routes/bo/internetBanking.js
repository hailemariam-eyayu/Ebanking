...
const prisma  = require('../../lib/prismaBO');   // audit only
...
router.post('/activate', verifyBO, async (req, res, next) => {
  try {
    const {
      ...
      activationLevel,   // 1 | 2 | 3
      approvalLimit,     // optional
    ...
    // Determine default activation level based on accountType
...
// ── IB Sub-users of a customer (for corporate) ────────────────────────────────
...
// PUT — update sub-user menu rights
